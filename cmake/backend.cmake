...
if(NOT gRPC_FOUND)
    if(WIN32)
        ...
        if(UNIX AND NOT APPLE)
            ...
            set(QCLASH_BACKEND_LIBRARY ${GRPC_LIBRARIES})
        else()
            ...
            set(QCLASH_BACKEND_LIBRARY ${GRPC_LINK_LIBRARIES} ${UPB_LIBRARY} ${ADDRESS_SORTING})
        endif()
    endif()
else()
    set(QCLASH_BACKEND_LIBRARY gRPC::gpr gRPC::grpc gRPC::grpc++ gRPC::grpc++_alts)
endif()
