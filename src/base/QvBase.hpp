...
#if !defined(QVMESSOCKET_DEFAULT_VCORE_PATH) && !defined(QCLASH_DEFAULT_VASSETS_PATH)
...
#define QVMESSOCKET_DEFAULT_VCTL_PATH (QVMESSOCKET_CONFIG_DIR + "vcore/v2ctl" QVMESSOCKET_EXECUTABLE_SUFFIX)
#elif defined(QVMESSOCKET_DEFAULT_VCORE_PATH) && defined(QCLASH_DEFAULT_VASSETS_PATH)

#else
#error Both QVMESSOCKET_DEFAULT_VCORE_PATH and QCLASH_DEFAULT_VASSETS_PATH need to be presented when using manually specify the paths.
#endif
